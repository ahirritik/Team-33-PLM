        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoMVersions_BoMs_BoMId",
                        column: x => x.BoMId,
                        principalTable: "BoMs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateNewVersion = table.Column<bool>(type: "bit", nullable: false),
                    ProposedCostPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ProposedSalePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ProposedComponents = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProposedOperations = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BoMVersionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoMComponents_BoMVersions_BoMVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedTime = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoMOperations_BoMVersions_BoMVersionId",
                        column: x => x.BoMVersionId,
                        principalTable: "BoMVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ECOApprovals_ECOs_ECOId",
                        column: x => x.ECOId,
                        principalTable: "ECOs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoMComponents_BoMVersionId",
                table: "BoMComponents",
                column: "BoMVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_BoMOperations_BoMVersionId",
                table: "BoMOperations",
                column: "BoMVersionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoMVersions_BoMId_VersionNumber",
                table: "BoMVersions",
                columns: new[] { "BoMId", "VersionNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BoMVersions_IsActive",
                table: "BoMVersions",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ECOApprovals_Decision",
                table: "ECOApprovals",
                column: "Decision");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVersions_IsActive",
